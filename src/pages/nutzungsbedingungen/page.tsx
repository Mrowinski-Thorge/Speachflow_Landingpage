...
const NUTZUNG_JSONLD = {
  ...
  '@type': 'WebPage',
  '@id': 'https://speachflow.app/nutzungsbedingungen',
  url: 'https://speachflow.app/nutzungsbedingungen',
  name: 'Nutzungsbedingungen – SpeachFlow',
  description: 'Nutzungsbedingungen der SpeachFlow GmbH. Informationen zu Leistungsbeschreibung, Nutzungsrechten, Preisen und Haftung.',
  inLanguage: 'de-DE',
...
export default function NutzungsbedingungenPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = 'Nutzungsbedingungen – SpeachFlow';
    ...
    const id = 'jsonld-nutzungsbedingungen';
    if (!document.getElementById(id)) {
      const script = document.createElement('script');
      script.id = id;
      script.type = 'application/ld+json';
      script.textContent = JSON.stringify(NUTZUNG_JSONLD);
